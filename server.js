...
const createDefaultInvestmentPlans = async () => {
    ...
    const defaultPlans = [
        ...
        },
        {
            ...
            max_amount: 1000000,
            daily_interest: 9,
            total_interest: 9 * firstThreeDuration,
            duration: firstThreeDuration,
            risk_level: 'high',
            raw_material: 'Stocks',
            category: 'stocks',
        ...
        },
        {
            ...
            max_amount: 25000,
            daily_interest: 9,
            total_interest: 9 * nextThreeDuration,
        ...
        },
        {
            ...
            max_amount: 150000,
            daily_interest: 10,
            total_interest: 10 * nextThreeDuration,
            duration: nextThreeDuration,
            risk_level: 'medium',
            raw_material: 'Stocks',
            category: 'stocks',
        ...
        },
        {
            ...
            max_amount: 750000,
            daily_interest: 13,
            total_interest: 13 * remainingDuration,
        ...
        },
        {
            ...
            max_amount: 300000,
            daily_interest: 11,
            total_interest: 11 * remainingDuration,
            duration: remainingDuration,
            risk_level: 'medium',
            raw_material: 'Stocks',
            category: 'stocks',
...
app.post('/api/investments', auth, upload.single('payment_proof'), [
    ...
    try {
        ...
        const interestTransaction = new Transaction({
            ...
            balance_before: freshUser.balance,
            balance_after: freshUser.balance,
